...
object Program:
  ...
  val myMain = Module(Nil,List(
    ...
    AutDecl("fifo",Nil,List("a"),List("b"),Automaton.fifo("a","b","r")),
    AutDecl("fifof",List("m"),List("a"),List("b"),Automaton.fifofull("a","b","r",Term.Var("m"))),
    AutDecl("timer",List("n"),List("a"),List("b"),Automaton.timer("a","b","r","t",Term.Var("n"))),
